...
${nuget_cmd} install src/ChannelEngine.Channel.ApiClient/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/ChannelEngine.Channel.ApiClient.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/ChannelEngine.Channel.ApiClient.dll \
-recurse:'src/ChannelEngine.Channel.ApiClient/*.cs' \
-doc:bin/ChannelEngine.Channel.ApiClient.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/ChannelEngine.Channel.ApiClient.dll was created successfully"
fi
