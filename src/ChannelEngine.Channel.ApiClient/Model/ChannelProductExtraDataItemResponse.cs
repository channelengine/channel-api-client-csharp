...
namespace ChannelEngine.Channel.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChannelProductExtraDataItemResponse")]
    public partial class ChannelProductExtraDataItemResponse : IEquatable<ChannelProductExtraDataItemResponse>, IValidatableObject
    {
        ...
        protected ChannelProductExtraDataItemResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelProductExtraDataItemResponse" /> class.
        /// </summary>
        ...
        public ChannelProductExtraDataItemResponse(string key = default(string), string value = default(string), ExtraDataType? type = default(ExtraDataType?), bool isPublic = default(bool))
        {
            // to ensure "key" is required (not null)
            if (key == null) {
                throw new ArgumentNullException("key is a required property for ChannelProductExtraDataItemResponse and cannot be null");
            }
            this.Key = key;
            this.Value = value;
            this.Type = type;
