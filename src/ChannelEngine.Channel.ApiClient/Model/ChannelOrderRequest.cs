...
namespace ChannelEngine.Channel.ApiClient.Model
{
    ...
    /// ChannelOrderRequest
    /// </summary>
    [DataContract(Name = "ChannelOrderRequest")]
    public partial class ChannelOrderRequest : IEquatable<ChannelOrderRequest>, IValidatableObject
    {
        ...
        public ChannelOrderRequest(ChannelAddressRequest billingAddress = default(ChannelAddressRequest), ChannelAddressRequest shippingAddress = default(ChannelAddressRequest), string channelOrderNo = default(string), bool? isBusinessOrder = default(bool?), bool keyIsMerchantProductNo = default(bool), List<ChannelOrderLineRequest> lines = default(List<ChannelOrderLineRequest>), string phone = default(string), string email = default(string), string companyRegistrationNo = default(string), string vatNo = default(string), string paymentMethod = default(string), string paymentReferenceNo = default(string), decimal shippingCostsInclVat = default(decimal), string currencyCode = default(string), DateTime orderDate = default(DateTime), string channelCustomerNo = default(string), Dictionary<string, string> extraData = default(Dictionary<string, string>))
        {
            ...
            if (billingAddress == null) {
                throw new ArgumentNullException("billingAddress is a required property for ChannelOrderRequest and cannot be null");
            }
            this.BillingAddress = billingAddress;
            // to ensure "shippingAddress" is required (not null)
            if (shippingAddress == null) {
                throw new ArgumentNullException("shippingAddress is a required property for ChannelOrderRequest and cannot be null");
            }
            this.ShippingAddress = shippingAddress;
            // to ensure "channelOrderNo" is required (not null)
            if (channelOrderNo == null) {
                throw new ArgumentNullException("channelOrderNo is a required property for ChannelOrderRequest and cannot be null");
            }
            this.ChannelOrderNo = channelOrderNo;
            // to ensure "lines" is required (not null)
            if (lines == null) {
                throw new ArgumentNullException("lines is a required property for ChannelOrderRequest and cannot be null");
            }
            this.Lines = lines;
            // to ensure "email" is required (not null)
            if (email == null) {
                throw new ArgumentNullException("email is a required property for ChannelOrderRequest and cannot be null");
            }
            this.Email = email;
            this.ShippingCostsInclVat = shippingCostsInclVat;
            // to ensure "currencyCode" is required (not null)
            if (currencyCode == null) {
                throw new ArgumentNullException("currencyCode is a required property for ChannelOrderRequest and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "ShippingAddress", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "KeyIsMerchantProductNo", EmitDefaultValue = true)]
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if(this.ChannelOrderNo != null && this.ChannelOrderNo.Length > 60)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ChannelOrderNo, length must be less than 60.", new [] { "ChannelOrderNo" });
            }
