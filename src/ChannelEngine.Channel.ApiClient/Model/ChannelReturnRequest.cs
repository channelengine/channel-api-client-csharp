...
namespace ChannelEngine.Channel.ApiClient.Model
{
    ...
    public partial class ChannelReturnRequest : IEquatable<ChannelReturnRequest>, IValidatableObject
    {
        ...
        public ChannelReturnRequest(string channelOrderNo = default(string), string merchantOrderNo = default(string), string channelReference = default(string), bool keyIsMerchantOrderNo = default(bool), bool keyIsMerchantProductNo = default(bool), List<ChannelReturnLineRequest> lines = default(List<ChannelReturnLineRequest>), int id = default(int), ReturnReason? reason = default(ReturnReason?), string customerComment = default(string), string merchantComment = default(string), decimal refundInclVat = default(decimal), decimal refundExclVat = default(decimal), DateTime? returnDate = default(DateTime?))
        {
