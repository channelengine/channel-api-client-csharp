...
namespace ChannelEngine.Channel.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChannelReturnRequest :  IEquatable<ChannelReturnRequest>
    {
        /// <summary>
