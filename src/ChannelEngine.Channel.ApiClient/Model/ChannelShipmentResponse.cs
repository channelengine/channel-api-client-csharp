...
namespace ChannelEngine.Channel.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChannelShipmentResponse")]
    public partial class ChannelShipmentResponse : IEquatable<ChannelShipmentResponse>, IValidatableObject
    {
        ...
        public ChannelShipmentResponse(string channelOrderNo = default(string), List<ChannelShipmentLineResponse> lines = default(List<ChannelShipmentLineResponse>), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), Dictionary<string, string> extraData = default(Dictionary<string, string>), string trackTraceNo = default(string), string trackTraceUrl = default(string), string returnTrackTraceNo = default(string), string method = default(string), string shippedFromCountryCode = default(string), DateTime? shipmentDate = default(DateTime?))
        {
            ...
            this.ChannelOrderNo = channelOrderNo ?? throw new ArgumentNullException("channelOrderNo is a required property for ChannelShipmentResponse and cannot be null");
            // to ensure "lines" is required (not null)
            this.Lines = lines ?? throw new ArgumentNullException("lines is a required property for ChannelShipmentResponse and cannot be null");
