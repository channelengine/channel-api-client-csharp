...
namespace ChannelEngine.Channel.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChannelOrderLineResponse")]
    public partial class ChannelOrderLineResponse : IEquatable<ChannelOrderLineResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelOrderLineResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChannelOrderLineResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelOrderLineResponse" /> class.
        /// </summary>
        ...
        public ChannelOrderLineResponse(OrderStatusView? status = default(OrderStatusView?), bool isFulfillmentByMarketplace = default(bool), string gtin = default(string), string description = default(string), decimal? unitVat = default(decimal?), decimal? lineTotalInclVat = default(decimal?), decimal? lineVat = default(decimal?), decimal? originalUnitPriceInclVat = default(decimal?), decimal? originalUnitVat = default(decimal?), decimal? originalLineTotalInclVat = default(decimal?), decimal? originalLineVat = default(decimal?), decimal originalFeeFixed = default(decimal), string bundleProductMerchantProductNo = default(string), string channelProductNo = default(string), string merchantProductNo = default(string), int quantity = default(int), int cancellationRequestedQuantity = default(int), decimal unitPriceInclVat = default(decimal), decimal feeFixed = default(decimal), decimal feeRate = default(decimal), Condition? condition = default(Condition?), DateTime? expectedDeliveryDate = default(DateTime?))
        {
            // to ensure "channelProductNo" is required (not null)
            this.ChannelProductNo = channelProductNo ?? throw new ArgumentNullException("channelProductNo is a required property for ChannelOrderLineResponse and cannot be null");
        ...
        {
            return this.Equals(input as ChannelOrderLineResponse);
        }

        /// <summary>
        /// Returns true if ChannelOrderLineResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ChannelOrderLineResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChannelOrderLineResponse input)
        {
            if (input == null)
                return false;
