...
namespace ChannelEngine.Channel.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectionOfChannelReturnResponse")]
    public partial class CollectionOfChannelReturnResponse : IEquatable<CollectionOfChannelReturnResponse>, IValidatableObject
    {
        ...
        public CollectionOfChannelReturnResponse(List<ChannelReturnResponse> content = default(List<ChannelReturnResponse>), int count = default(int), int totalCount = default(int), int itemsPerPage = default(int), int statusCode = default(int), string requestId = default(string), string logId = default(string), bool success = default(bool), string message = default(string), Dictionary<string, List<string>> validationErrors = default(Dictionary<string, List<string>>))
        {
