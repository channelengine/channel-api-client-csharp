...
namespace ChannelEngine.Channel.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CollectionOfChannelReturnResponse :  IEquatable<CollectionOfChannelReturnResponse>
    {
        /// <summary>
        ...
        public CollectionOfChannelReturnResponse(List<ChannelReturnResponse> content = default(List<ChannelReturnResponse>), int? count = default(int?), int? totalCount = default(int?), int? itemsPerPage = default(int?), int? statusCode = default(int?), int? logId = default(int?), bool? success = default(bool?), string message = default(string), Dictionary<string, List<string>> validationErrors = default(Dictionary<string, List<string>>))
        {
