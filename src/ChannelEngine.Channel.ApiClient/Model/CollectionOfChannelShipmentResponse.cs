...
namespace ChannelEngine.Channel.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CollectionOfChannelShipmentResponse :  IEquatable<CollectionOfChannelShipmentResponse>
    {
        /// <summary>
