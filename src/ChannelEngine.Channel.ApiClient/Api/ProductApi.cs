...
namespace ChannelEngine.Channel.ApiClient.Api
{
    ...
    public interface IProductApiSync : IApiAccessor
    {
        ...
        SingleOfChannelProductChangesResponse ProductGetDataChanges(int? maxCount = default(int?), bool? stripHtml = default(bool?), int? page = default(int?), int? pageSize = default(int?));
        ...
        ApiResponse<SingleOfChannelProductChangesResponse> ProductGetDataChangesWithHttpInfo(int? maxCount = default(int?), bool? stripHtml = default(bool?), int? page = default(int?), int? pageSize = default(int?));
        /// <summary>
    ...
    public interface IProductApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SingleOfChannelProductChangesResponse> ProductGetDataChangesAsync(int? maxCount = default(int?), bool? stripHtml = default(bool?), int? page = default(int?), int? pageSize = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SingleOfChannelProductChangesResponse>> ProductGetDataChangesWithHttpInfoAsync(int? maxCount = default(int?), bool? stripHtml = default(bool?), int? page = default(int?), int? pageSize = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get Product Data Changes with an optional product type filter. If you select product type products will be filtered by it.  If you won&#39;t pass product type you will get products with types: CHILD, PARENT, GRANDPARENT, SINGLE
        /// </summary>
        /// <remarks>
    ...
    public partial class ProductApi : IProductApi
    {
        ...
        /// <param name="pageSize"> (optional)</param>
        /// <returns>SingleOfChannelProductChangesResponse</returns>
        public SingleOfChannelProductChangesResponse ProductGetDataChanges(int? maxCount = default(int?), bool? stripHtml = default(bool?), int? page = default(int?), int? pageSize = default(int?))
        {
            ChannelEngine.Channel.ApiClient.Client.ApiResponse<SingleOfChannelProductChangesResponse> localVarResponse = ProductGetDataChangesWithHttpInfo(maxCount, stripHtml, page, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="pageSize"> (optional)</param>
        /// <returns>ApiResponse of SingleOfChannelProductChangesResponse</returns>
        public ChannelEngine.Channel.ApiClient.Client.ApiResponse<SingleOfChannelProductChangesResponse> ProductGetDataChangesWithHttpInfo(int? maxCount = default(int?), bool? stripHtml = default(bool?), int? page = default(int?), int? pageSize = default(int?))
        {
            ChannelEngine.Channel.ApiClient.Client.RequestOptions localVarRequestOptions = new ChannelEngine.Channel.ApiClient.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SingleOfChannelProductChangesResponse</returns>
        public async System.Threading.Tasks.Task<SingleOfChannelProductChangesResponse> ProductGetDataChangesAsync(int? maxCount = default(int?), bool? stripHtml = default(bool?), int? page = default(int?), int? pageSize = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ChannelEngine.Channel.ApiClient.Client.ApiResponse<SingleOfChannelProductChangesResponse> localVarResponse = await ProductGetDataChangesWithHttpInfoAsync(maxCount, stripHtml, page, pageSize, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
