...
namespace ChannelEngine.Channel.ApiClient.Api
{
    ...
    public interface IShipmentApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<CollectionOfChannelShipmentResponse>> ShipmentIndexWithHttpInfoAsync(DateTime? createdSince = default(DateTime?), List<ShipmentStatus> statuses = default(List<ShipmentStatus>), DateTime? fromDate = default(DateTime?), DateTime? toDate = default(DateTime?), List<string> channelOrderNos = default(List<string>), int? page = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Download shipping label.
        /// </summary>
        /// <remarks>
    ...
    public partial class ShipmentApi : IShipmentApi
    {
        ...
        {
            ChannelEngine.Channel.ApiClient.Client.ApiResponse<CollectionOfChannelShipmentResponse> localVarResponse = await ShipmentIndexWithHttpInfoAsync(createdSince, statuses, fromDate, toDate, channelOrderNos, page, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CollectionOfChannelShipmentResponse)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Channel.ApiClient.Client.ApiResponse<CollectionOfChannelShipmentResponse>> ShipmentIndexWithHttpInfoAsync(DateTime? createdSince = default(DateTime?), List<ShipmentStatus> statuses = default(List<ShipmentStatus>), DateTime? fromDate = default(DateTime?), DateTime? toDate = default(DateTime?), List<string> channelOrderNos = default(List<string>), int? page = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
