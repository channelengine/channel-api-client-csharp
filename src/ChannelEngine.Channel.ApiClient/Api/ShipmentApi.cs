...
namespace ChannelEngine.Channel.ApiClient.Api
{
    ...
    public interface IShipmentApiSync : IApiAccessor
    {
        ...
        /// <param name="statuses">Deprecated, shipment status(es) to filter on. (optional)</param>
    ...
    public partial class ShipmentApi : IShipmentApi
    {
        ...
        {
             ChannelEngine.Channel.ApiClient.Client.ApiResponse<System.IO.Stream> localVarResponse = await ShipmentShippingLabelAsyncWithHttpInfo(merchantShipmentNo, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Channel.ApiClient.Client.ApiResponse<System.IO.Stream>> ShipmentShippingLabelAsyncWithHttpInfo (string merchantShipmentNo, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'merchantShipmentNo' is set
            if (merchantShipmentNo == null)
                throw new ChannelEngine.Channel.ApiClient.Client.ApiException(400, "Missing required parameter 'merchantShipmentNo' when calling ShipmentApi->ShipmentShippingLabel");
